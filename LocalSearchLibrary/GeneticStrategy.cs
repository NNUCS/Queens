...
namespace LocalSearchLibrary
{
    ...
    {
        private List<Board> _popBoards = new List<Board>();
        ...
        public GeneticStrategy(Board brd)
            : base(brd)
        {
            if (brd.Status == "")
            {
            ...
            else
            {
                if (brd.objStuffToStash != null)
                {
                    ...
                    {
                        _popBoards = (List<Board>)brd.objStuffToStash;
        ...
        {
            Board brdWinner, brdLoser, brdTemp;
